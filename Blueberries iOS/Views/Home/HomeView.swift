...
struct HomeView: View {
    ...
    var body: some View {
        VStack {
            ...
            ZStack {
                CircleProgressView(theme: appSettings.selectedTheme, percentage: appTimer.percentage, title: appTimer.isStopwatch ? appTimer.pastTimeString : appTimer.remainingTimeString, subtitle: appTimer.state == .off ? "" : appTimer.isSession ? "session".localize() : "break".localize(), fontSize: 50)
